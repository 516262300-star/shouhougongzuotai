        ...
        return_match_state = and_(
            ...
            or_(
                ...
                and_(
                    ...
                    AftersalesActionTask.payload["erp_refund_message"].as_string().in_(
                        tuple(MANUAL_REASONS),
                    ),
