...
> 2026-09-10 审计修复分支：请先阅读[资金、退款与发送安全修复说明](docs/audit-safety-fixes-20260910.md)。天猫未适配的整包裹自动退款已失败关闭；ERP明细匹配不再冒充质检通过，桌面发送不再凭画面变化确认成功。需要新数据库迁移，尚未部署或验收，普通在途业务口径待确认。
