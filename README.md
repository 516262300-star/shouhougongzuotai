...
2026-09-24 用户授权抖音四店模块1/2/3及现有积压接入，当前发布/验收状态与边界见[模块有限开启说明](docs/douyin-modules123-rollout-20260924.md)。独立退款API不留言、资金不重试；复杂合包、暂存认领、缺独立质检仍保留人工。此前[普通发货20小时提醒候选](docs/douyin-reminder-module3-20260924.md)的独立开关不随本次开启。
