...
2026-09-10 在途人工待办简化：去掉业务员可见的 `M1`、`模块1`、物流代码和重复平台订单号；新生成和未发送旧任务均采用短文案。内部任务编号与原因保留，发布兼容两代旧标识查重，不重发已发布待办，也不改变退款或同包裹人工锁。模板、验证及加载边界见[人工待办文案简化说明](docs/manual-todo-concise-20260910.md)。
