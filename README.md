...
2026-09-24 16:07 已按用户授权在正式机有限开启抖音四店模块1/2/3，并纳入现有待处理积压，发布/验收状态与边界见[模块有限开启说明](docs/douyin-modules123-rollout-20260924.md)。独立退款API不留言、资金不重试；复杂合包、部分退款、暂存认领、缺独立质检仍保留人工，不能宣称积压全部处理完。此前[普通发货20小时提醒候选](docs/douyin-reminder-module3-20260924.md)的独立开关不随本次开启。
